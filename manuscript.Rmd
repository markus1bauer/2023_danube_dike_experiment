...
Reference vegetation surveys were extracted from sPlotOpen [@Sabatini.2021] and our owen surveys in the surroundings on Danube dikes [@bauer2023]. We chose

<!--# Mention traits -->

## Statistical analyses {.unnumbered}

A non-metric multidimensional scaling ordination (NMDS) with Jaccard dissimilarity was used to visualize variation in species composition in space and time. Rare species with an accumulated cover over all plots of less than 0.5% were excluded (2D-stress: 0.21). <!--# Refer to Table Sx -->

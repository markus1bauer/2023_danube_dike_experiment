...
Each plot received an individual set of 20 species with some restrictions to the number of species per functional group. The total species pool for hay meadows was 55 and for dry grassland 58. In total, plots received 16 or 32 g of seeds. All individual seed mixtures are stored in Appendix A3.

```{r tab.id = "seedmix", ft.align = "left", tab.cap = "Seedmix"}
...
```{r tab.id = "substrate", ft.align = "left", tab.cap = "Substrate"}

...
The ordination showed the species composition of seed mixtures and the development of the plots during four years (Figure \@ref(fig:nmds); 2D-stress: 0.21). The NMDS confirmed that the seed mixtures were variable, albeit distinctive for hay meadows and dry grasslands and confirming the intended direction of the vegetation development. As one exception, hay meadows in south exposition did not develop towards their seed-mixture compositions.

...
\* Corresponding author: [markus1.bauer\@tum.de](mailto:markus1.bauer@tum.de) <!--# check if it still treated as bullet point -->

<mark>Max 8000 words</mark> <!--# Remove -->
...
The software and the whole model specification and evaluation is stored on Zenodo and in an easily accessible a scroll-down document on GitHub (see \@ref(open-research)). There, the sections are referenced to the Bayesian analysis reporting guidelines [BARG, @kruschke2021].
...
# Open research {#sec-open-research-open-research-.unnumbered .unnumbered}

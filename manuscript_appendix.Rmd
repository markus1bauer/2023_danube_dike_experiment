...
All sown seed mixtures can be found on GitHub in the folder 'outputs/tables/ table_a2_seed_mixtures.csv'. <!--# Cite Zenodo--> There, we indicate which species were combined and their respective ratio in the specific seed mixture.
...
-   Species, for which no seeds were available in the market or which are difficult to establish by propagule application, e.g., *Carex* spec. or cryptogams

...
data2 <- rename(sites, predicted = cwmAbuHeight, x = changeType, group = surveyYearF)
...
(graph <- ggplot(pdata, 
    ...
    scale_y_continuous(limits = c(0, 1.1), breaks = seq(-100, 100, .1)) +
...
ggsave("figure_cwmHeight_(800dpi_8x7cm).tiff",

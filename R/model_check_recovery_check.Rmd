...
Markov Chain Monte Carlo (MCMC) method used with No-U-Turn Sampler (NUTS) sampler which is an extension of Hamiltonian Monte Carlo (HMC).
...
loo1 <- m_1 %>% brms::loo(save_psis = TRUE, moment_match = FALSE)
loo2 <- m_2 %>% brms::loo(save_psis = TRUE, moment_match = FALSE)
loo1
loo2
plot(loo1)
plot(loo2)

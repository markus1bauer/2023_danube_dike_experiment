---
title: "Analysis of Bauer et al. (unpublished) Field experiment: <br> Favourable Conservation Status (FCS)"
...
```{r mcmc}
mcmc_trace(posterior1, np = hmc_diagnostics1, facet_args = list(ncolumn = 2))
mcmc_trace(posterior2, np = hmc_diagnostics2, facet_args = list(ncolumn = 2))

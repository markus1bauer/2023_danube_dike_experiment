...
<<<<<<< Updated upstream:R/show_figure_2_fcs.R
## 1 Marginal effects #########################################################

(p1 <- ggplot(data = sites) +
=======
## 1 Boxplots #################################################################
<<<<<<< Updated upstream:R/show_figure_2_fcs_target.R
...
>>>>>>> Stashed changes:R/show_figure_2_fcs.R
test <- sites %>%
  add_predicted_draws(m3, allow_new_levels = TRUE)
  
ggplot(data = sites) +
  #geom_boxplot(aes(y = n, x = sand_ratio, color = target_type)) +
>>>>>>> Stashed changes:R/show_figure_2_fcs_target.R
  geom_quasirandom(

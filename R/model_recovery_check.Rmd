...
### Coefficient of determination (<i>R</i>^2)

#### Conditional <i>R</i>^2 values

```{r conditonal-r2 collapse = TRUE}
...
hmc_diagnostics1 <- bayesplot::nuts_params(m_1)
hmc_diagnostics2 <- bayesplot::nuts_params(m_2)
y <- sites$n
...
```{r conditional-marginal-r2 collapse = TRUE}
brms::bayes_R2(m_1, probs = c(0.05, 0.5, 0.95),

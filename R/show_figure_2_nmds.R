...
ggsave(here("outputs", "figures", "figure_2_nmds_300dpi_16.5x16cm.tiff"),
       dpi = 300, width = 16.5, height = 16, units = "cm")
graph_a + theme(legend.position = "right")
ggsave(here("outputs", "figures", "figure_2_nmds_300dpi_18x13cm.tiff"),

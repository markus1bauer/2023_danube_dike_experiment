...
![](model_fcs_markdown_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](model_fcs_markdown_files/figure-gfm/unnamed-chunk-8-2.png)<!-- -->
...
![](model_fcs_markdown_files/figure-gfm/unnamed-chunk-8-3.png)<!-- -->
...
``` r
write.csv(draws2, here("outputs", "statistics", "table_fcs_test.csv"))
```
